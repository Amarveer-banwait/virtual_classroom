                    ...
                    <div class="bp-row">
                        <div class="bp-col">
                            <div class="page__title mb30">
                                <span><a href="<?php echo esc_url(admin_url("admin.php?page=better-payment-transactions")); ?>"><i class="bp-icon bp-caret-left"></i></a> <?php _e('Back to Transactions', 'better-payment'); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bp-row">
                        <div class="bp-col-lg-8 bp-col md-mb30">
                            <div class="transaction__info__wrap">
                                ...
                                $td_first_name = (isset($form_fields_info['first_name']) && $form_fields_info['first_name']) ? $form_fields_info['first_name'] : __('N/A', 'better-payment');
                                $td_last_name = (isset($form_fields_info['last_name']) && $form_fields_info['last_name']) ? $form_fields_info['last_name'] : __('N/A', 'better-payment');
                                $td_email = $bp_admin_transaction->email;
                                $td_amount = $bp_admin_transaction->amount . ' ' . $bp_admin_transaction->currency;
                                $td_source_image_url = $bp_admin_transaction->source == 'paypal' ? BETTER_PAYMENT_ADMIN_ASSET_URL . 'img/paypal.png' : BETTER_PAYMENT_ADMIN_ASSET_URL . 'img/stripe.svg';
                                $td_status = $bp_admin_transaction->status ? $bp_admin_transaction->status : __('N/A', 'better-payment');
                                $td_status_btn_color = $td_status == 'paid' ? 'label__primary' : 'label__warning';
                                $td_status_btn_color = $td_status == 'unpaid' ? 'label__danger' : $td_status_btn_color;
                                ...
                                <div class="transaction__info">
                                    ...
                                    <ul class="informations">
                                        ...
                                        <li><span><?php _e('Status:', 'better-payment'); ?></span> <span class="text__label <?php echo esc_attr($td_status_btn_color); ?>"> <?php echo esc_html(ucwords($td_status)); ?> </span></li>
                                    </ul>
                                </div>
                                <div class="transaction__info">
                                    <div class="info__header">
                                    ...
                                    <ul class="informations">
                                        ...
                                        <li><span><?php _e('Referer Widget:', 'better-payment'); ?></span> <?php echo esc_html($referer_content_form_name) ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="payment__getway">
                                    ...
                                    <div class="pay__by">
                                        ...
                                        <label class="<?php echo esc_attr($paid_via_paypal_selected); ?>">
                                            <?php _e('Paid via:', 'better-payment'); ?>
                                            <input type="radio" name="payment__getway" <?php echo $bp_admin_transaction->source == 'paypal' ? 'checked' : ''; ?> >
                                            <span><img src="<?php echo esc_url(BETTER_PAYMENT_ADMIN_ASSET_URL . 'img/paypal.png'); ?>" alt=""></span>
                                        </label>
