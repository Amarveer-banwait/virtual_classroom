...
class Better_Payment_Setup_Wizard
{
    ...
    public function setup_wizard_scripts($hook)
    {
        if (isset($hook) && $hook == 'admin_page_better-payment-setup-wizard') {
            ...
            wp_enqueue_style('bp-setup-wizard-style', BETTER_PAYMENT_ADMIN_ASSET_URL . 'css/setup-wizard.min.css', null, $this->file_version);
            ...
            //Scripts
            wp_enqueue_script('bp-setup-wizard-js', BETTER_PAYMENT_ADMIN_ASSET_URL . 'js/setup-wizard.min.js', null, $this->file_version);
            
            wp_localize_script('bp-setup-wizard-js', 'betterPaymentObjWizard', array(
                'nonce'  => wp_create_nonce('better_payment_admin_nonce'),
                'success_image' => BETTER_PAYMENT_ADMIN_ASSET_URL . 'img/success.gif',
                'alerts' => [
    ...
    public function tab_step()
    {
        $wizard_column = 'four';
    ?>
        <ul class="better-payment-setup-wizard <?php echo $wizard_column; ?>" data-step="0">
            <li class="step">
                <div class="icon">
                ...
                <div class="name"><?php _e('Getting Started', 'better-payment'); ?></div>
            </li>
            <li class="step">
                <div class="icon">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 50 50" style="enable-background:new 0 0 50 50;" xml:space="preserve">
...
l-5.2-5.2l8.8-8.8C50.4,20.4,50.4,18,48.9,16.6z" />
                ...
                <div class="name"><?php _e('Stripe Configuration', 'better-payment'); ?></div>
            </li>
            <li class="step">
                <div class="icon">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 50 50" style="enable-background:new 0 0 50 50;" xml:space="preserve">
...
l-5.2-5.2l8.8-8.8C50.4,20.4,50.4,18,48.9,16.6z" />
                ...
                <div class="name"><?php _e('PayPal Configuration', 'better-payment'); ?></div>
            </li>
            <li class="step">
                <div class="icon">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 50 50" style="enable-background:new 0 0 50 50;" xml:space="preserve">
...
c2.2,0,4.2-1.1,5.4-2.8L49.1,9.5C50.5,7.5,50.2,4.8,48.5,3.1z" />
                ...
                <div class="name"><?php _e('Finalize', 'better-payment'); ?></div>
            </li>
        </ul>
    <?php
    }
            ...
            <form method="post" id="better-payment-admin-settings-form" class="better-payment-setup-wizard-form" action="#">
                    ...
                    <div class="payment__options">
                        ...
                        <div class="payment__option bp-stripe-key bp-stripe-live-key <?php echo $better_payment_settings_payment_stripe_live ? 'bp-d-block' : 'bp-d-none' ?>">
                            ...
                            <div class="active__status input__wrap">
                                <input type="text" class="form__control mt15" name="better_payment_settings_payment_stripe_live_public" value="<?php echo isset($bp_admin_saved_settings['better_payment_settings_payment_stripe_live_public']) ? $bp_admin_saved_settings['better_payment_settings_payment_stripe_live_public'] : '' ?>" type="text" placeholder="<?php //_e('Live public key', 'better-payment'); ?>">
                            </div>
                        </div>
                        <div class="payment__option bp-stripe-key bp-stripe-live-key <?php echo $better_payment_settings_payment_stripe_live ? 'bp-d-block' : 'bp-d-none' ?>">
                            <div class="payment__option__content">
                            ...
                            <div class="active__status input__wrap">
                                <input type="password" class="form__control mt15" name="better_payment_settings_payment_stripe_live_secret" value="<?php echo isset($bp_admin_saved_settings['better_payment_settings_payment_stripe_live_secret']) ? $bp_admin_saved_settings['better_payment_settings_payment_stripe_live_secret'] : '' ?>">
                            </div>
                        </div>
                        <div class="payment__option bp-stripe-key bp-stripe-test-key <?php echo $better_payment_settings_payment_stripe_live ? 'bp-d-none' : 'bp-d-block' ?> ">
                            ...
                            <div class="active__status input__wrap">
                                <input type="text" class="form__control mt15" name="better_payment_settings_payment_stripe_test_public" value="<?php echo isset($bp_admin_saved_settings['better_payment_settings_payment_stripe_test_public']) ? $bp_admin_saved_settings['better_payment_settings_payment_stripe_test_public'] : '' ?>">
                            </div>
                        </div>
                        <div class="payment__option bp-stripe-key bp-stripe-test-key <?php echo $better_payment_settings_payment_stripe_live ? 'bp-d-none' : 'bp-d-block' ?> ">
                            <div class="payment__option__content">
                            ...
                            <div class="active__status input__wrap">
                                <input type="password" class="form__control mt15" name="better_payment_settings_payment_stripe_test_secret" value="<?php echo isset($bp_admin_saved_settings['better_payment_settings_payment_stripe_test_secret']) ? $bp_admin_saved_settings['better_payment_settings_payment_stripe_test_secret'] : '' ?>">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="quick-setup-paypal" class="setup-content quick-setup-paypal better-payment-box">
                    <div class="payment__options ">
                        ...
                        <div class="payment__option">
                            ...
                            <div class="active__status input__wrap">
                                <input type="email" class="form__control" name="better_payment_settings_payment_paypal_email" value="<?php echo isset($bp_admin_saved_settings['better_payment_settings_payment_paypal_email']) ? $bp_admin_saved_settings['better_payment_settings_payment_paypal_email'] : '' ?>">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="finalize" class="setup-content better-payment-box">
                    <header class="pb31 text-center">
                        <div class="bp-container">
                            <div class="bp-row">
                                <div class="bp-col">
                                    <div class="logo">
                                        <a href="javascript:void(0)"><img src="<?php echo BETTER_PAYMENT_ADMIN_ASSET_URL . 'img/logo.svg'; ?>" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </header>
                    <h2 class="text-center"><?php _e('Great Job! Your Configuration is Complete ', 'better-payment'); ?>🎉</h2>
                    <p> <input class="better_payment_settings_opt_in" type="checkbox" name="better_payment_settings_opt_in" value="yes" <?php echo isset($bp_admin_saved_settings['better_payment_settings_opt_in']) && $bp_admin_saved_settings['better_payment_settings_opt_in'] == 'yes' ? ' checked' : '' ?>>
                        <label for="better_payment_settings_opt_in"><?php _e('Share non-sensitive diagnostic data and plugin usage information.', 'better-payment'); ?></label>
                    </p>
                    <p><?php _e('What do we collect? We collect non-sensitive diagnostic data and plugin usage information. Your site URL, WordPress & PHP version, plugins & themes and email address to send you the discount coupon. This data lets us make sure this plugin always stays compatible with the most popular plugins and themes. No spam, we promise.', 'better-payment'); ?></p>
                </div>
            </form>
        </div>
    <?php
    ...
    ?>
        <div class="better-payment better-payment-setup-footer">
            <button id="better-payment-prev" class="button button__active better-payment-admin-settings-button"><?php _e('< Previous', 'better-payment') ?></button>
            <button id="better-payment-next" class="button button__active better-payment-admin-settings-button"><?php _e('Next >', 'better-payment') ?></button>
            <button id="better-payment-save" style="display: none" class="button button__active better-payment-admin-settings-button better-payment-setup-wizard-save"><?php _e('Finish', 'better-payment') ?></button>
        </div>
    <?php
    }
    ...
    ?>
        <script>
            document.title = "<?php _e('Quick Setup Wizard - Better Payment', 'better-payment'); ?>"
        </script>
    <?php
    }
}